            ...
            new Thread(new Runnable(){
                public void run()
                {
                    ...
                    while (true)
                    {
                        ...
                        if (bmpToSave.size() > index) ApplicationHelper.saveMyBitmap(ApplicationHelper.compressImage(bmpToSave.get(index).bitmap), bmpToSave.get(index).path+".cache",false);
