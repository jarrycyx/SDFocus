        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (type==0) {
                    ...
                    imageChooserManager = new ImageChooserManager(UserActivity.this, ChooserType.REQUEST_PICK_PICTURE, true);
                ...
                if (e==null) {
                    ...
                    for (int i = 0; i < avobjects.size(); i++) {
                        ...
                        if (ifLoadImg) {
                            ...
                            }else if (avFile!=null) avFile.getDataInBackground(new GetDataCallback() {
